export const surpriseMePrompts = [
    ...
    "An abstract representation of technology and connectivity",
    "A fantasy creature in a magical forest",
    "A vintage street with cobblestone roads and old-fashioned lampposts",
    "A surreal underwater world with vibrant marine life",
    "A cozy cottage in the countryside surrounded by flowers",
    "A bustling market scene with colorful stalls and people",
    "A celestial scene with planets, stars, and galaxies",
